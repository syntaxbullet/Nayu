...
import { darkColor, lightColor } from "./nayu";
...
export const getNayu = (isDarkMode = false) =>
...
export const nayuDark = getNayu(true);
export const nayuLight = getNayu(false);
...
export const nayu = getNayu(darkMode);

export { color, darkColor, lightColor } from "./nayu";
